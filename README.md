...
```mermaid
graph TD
    A[Cliente: React SPA] -->|HTTP REST + JWT| B[BFF: Express.js]
    B -->|Transparencia Firma Jimp| B
    B -->|Proxy de Peticiones| C[Orquestador: n8n]
    C -->|Consultas y SPs| D[(SQL Server / Oracle)]
    B -->|Generación .docx| E[Gotenberg 8]
    E -->|Conversión Headless PDF| B
    C -->|SMTP| F[Envío de Contratos al Candidato]
```
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=TU_USUARIO_AQUÍ&show_icons=true&theme=tokyonight&locale=es" alt="Estadísticas de Andrés" height="150" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=TU_USUARIO_AQUÍ&layout=compact&theme=tokyonight&locale=es" alt="Lenguajes de Andrés" height="150" />
</p>
...
*   💼 **LinkedIn:** [Andrés Orozco](https://www.linkedin.com/in/andrés-orozco-76bb85237/)
